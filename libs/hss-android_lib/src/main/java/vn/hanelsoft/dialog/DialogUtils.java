...
public class DialogUtils extends Dialog {
    ...
    public static DialogUtils show(Context context, String message) {
        return show(context, message, null, null);
    }

    public static DialogUtils show(Context context, String message, String txtAccept) {
        return show(context, message, txtAccept, null);
    }

    public static DialogUtils show(Context context, String message, View.OnClickListener accept) {
        return show(context, message, null, accept);
    }

    public static DialogUtils show(Context context, String message, String txtAccept, View.OnClickListener accept) {
